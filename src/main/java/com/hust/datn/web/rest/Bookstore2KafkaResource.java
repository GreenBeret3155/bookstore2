...
@RestController
@RequestMapping("/api/bookstore-2-kafka")
public class Bookstore2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Bookstore2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Bookstore2KafkaResource(KafkaProperties kafkaProperties) {
